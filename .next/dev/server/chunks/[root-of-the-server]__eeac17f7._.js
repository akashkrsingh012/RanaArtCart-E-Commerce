...
"[project]/handmade-arts-e-commerce/app/api/orders/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request, prop) {
    ...
    try {
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$handmade$2d$arts$2d$e$2d$commerce$2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!order) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$handmade$2d$arts$2d$e$2d$commerce$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(request, prop) {
    const params = await prop.params;
    try {
        const user = await getUser(request);
        if (!user) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eeac17f7._.js.map