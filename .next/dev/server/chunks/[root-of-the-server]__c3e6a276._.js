...
"[project]/handmade-arts-e-commerce/app/api/products/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$handmade$2d$arts$2d$e$2d$commerce$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
...
async function DELETE(request, { params }) {
    try {
        ...
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$handmade$2d$arts$2d$e$2d$commerce$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            _id: id,
            sellerId: sellerId
        });
        if (!product) {
        ...
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$handmade$2d$arts$2d$e$2d$commerce$2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].updateMany({
                "items.productId": id,
                status: {
                    $in: [
                        "Pending",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3e6a276._.js.map